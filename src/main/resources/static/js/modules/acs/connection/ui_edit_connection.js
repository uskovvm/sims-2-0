...
define(['jquery', 'react', 'react-dom', 'objects', 'dao/core', 'core/logger', './ui_connection_selector', 'ui/ui_elements'], function ($, React, ReactDOM, Objects, CoreDao, Log, ConnectionSelector, Elements) {
  return React.createClass({
    getInitialState: function () {
      return {
        connection: Objects.clone(this.props.data.connection)
      };
    },
    onOk: function () {
      let self = this;
    ...
    render: function () {
      ...
      self.props.data.connectionTypes.forEach(function (el) {
      ...
      let connectionType = self.props.data.connectionTypes.find(el => {
